...
<head>
    ...
    <title>Vidrios - Vidrios Y Aceros Sandra</title>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/productos/vidrios" class="btn btn-primary">Ver más</a>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Baños de vidrio elegantes y modernos. Diseño contemporáneo que aporta luminosidad y amplitud a tu espacio.</p>
                        <a href="/productos/banos" class="btn btn-primary">Ver más</a>
                        <button class="btn btn-warning btn-edit" data-toggle="modal" data-target="#addEditModal">Editar</button>
                        <button class="btn btn-disable">Deshabilitar</button>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Puertas de vidrio resistentes y estéticas. Ideales para interiores y exteriores, con diseños personalizados.</p>
                        <a href="/productos/puertas" class="btn btn-primary">Ver más</a>
                        <button class="btn btn-warning btn-edit" data-toggle="modal" data-target="#addEditModal">Editar</button>
                        <button class="btn btn-disable">Deshabilitar</button>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Ventanas de vidrio de alta eficiencia energética. Aislantes térmicos y acústicos para tu hogar o negocio.</p>
                        <a href="/productos/ventanas" class="btn btn-primary">Ver más</a>
                        <button class="btn btn-warning btn-edit" data-toggle="modal" data-target="#addEditModal">Editar</button>
                        <button class="btn btn-disable">Deshabilitar</button>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Repisas de vidrio elegantes y funcionales. Perfectas para cualquier espacio, combinando estilo y practicidad.</p>
                        <a href="/productos/repisas" class="btn btn-primary">Ver más</a>
                        <button class="btn btn-warning btn-edit" data-toggle="modal" data-target="#addEditModal">Editar</button>
                        <button class="btn btn-disable">Deshabilitar</button>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Servicios adicionales de instalación y mantenimiento. Profesionales capacitados para todas tus necesidades de vidrio.</p>
                        <a href="/productos/otros" class="btn btn-primary">Ver más</a>
                        <button class="btn btn-warning btn-edit" data-toggle="modal" data-target="#addEditModal">Editar</button>
                        <button class="btn btn-disable">Deshabilitar</button>
                    </div>
                </div>
