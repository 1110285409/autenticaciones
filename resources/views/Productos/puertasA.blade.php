...
<head>
    ...
    <title>ProductAceros - Puertas de Acero Inoxidable</title>
...
<body>
    <header class="header text-center py-3">
        <h1>ProductAceros - Puertas de Acero Inoxidable</h1>
    ...
    <main class="container mt-5">
        <div class="row">
            <!-- Información de Puertas de Acero Inoxidable -->
            <div class="col-md-6">
                <h2>Puertas de Acero Inoxidable de Alta Calidad</h2>
                <p>En Vidrios Y Aceros Sandra, ofrecemos una variedad de puertas de acero inoxidable de alta calidad, incluyendo accesorios para puertas de archivos, accesorios para puertas, chapas y tiradores de acero inoxidable. Nuestros productos destacan por su durabilidad, resistencia a la corrosión y estética moderna, proporcionando soluciones elegantes y funcionales para tu hogar o negocio.</p>
                
                <div class="row">
                    <!-- Accesorios para Puertas de Archivos -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/accesorios_puertas_archivos.jpeg') }}" class="card-img-top" alt="Accesorios para Puertas de Archivos">
                            <div class="card-body">
                                <h5 class="card-title">Accesorios para Puertas de Archivos</h5>
                                <p class="card-text">Nuestros accesorios para puertas de archivos en acero inoxidable ofrecen una solución duradera y estética para cualquier tipo de archivo o gabinete.</p>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/accesorios_puertas.jpeg') }}" class="card-img-top" alt="Accesorios para Puertas">
                            <div class="card-body">
                                <h5 class="card-title">Accesorios para Puertas</h5>
                                <p class="card-text">Nuestros accesorios para puertas en acero inoxidable combinan funcionalidad y estilo, proporcionando una solución resistente y estética para cualquier puerta.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
                    ...
                    <!-- Chapas en Acero Inoxidable -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/chapas_acero_inoxidable.jpeg') }}" class="card-img-top" alt="Chapas en Acero Inoxidable">
                            <div class="card-body">
                                <h5 class="card-title">Chapas en Acero Inoxidable</h5>
                                <p class="card-text">Nuestras chapas en acero inoxidable ofrecen una solución segura y duradera para cualquier tipo de puerta, combinando resistencia y estética moderna.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
                    ...
                    <!-- Tiradores de Acero Inoxidable para Puertas Exterior -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/tiradores_acero_inoxidable.jpeg') }}" class="card-img-top" alt="Tiradores de Acero Inoxidable para Puertas Exterior">
                            <div class="card-body">
                                <h5 class="card-title">Tiradores de Acero Inoxidable para Puertas Exterior</h5>
                                <p class="card-text">Nuestros tiradores de acero inoxidable para puertas exteriores ofrecen una solución elegante y funcional, ideales para cualquier tipo de puerta exterior.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
            ...
            <div class="col-md-6">
                <h5>Solicita tu Puerta de Acero Inoxidable</h5>
                <form id="form-pedido" onsubmit="return validateForm()">
                    <div class="form-group">
                        <label for="tipoPuerta">Tipo de Producto</label>
                        <select class="form-control" id="tipoPuerta" name="tipoPuerta" required>
                            <option value="accesorios_archivos">Accesorios para Puertas de Archivos</option>
                            <option value="accesorios_puertas">Accesorios para Puertas</option>
                            <option value="chapas">Chapas en Acero Inoxidable</option>
                            <option value="tiradores_exterior">Tiradores de Acero Inoxidable para Puertas Exterior</option>
                        </select>
                    </div>
                    <div class="form-group">
