...
<head>
    ...
    <title>ProductVidrios - Vidrios Y Aceros Sandra</title>
...
<body>
    ...
    <main class="container mt-5">
        <div class="row">
            <!-- Información de Vidrios -->
            <div class="col-md-6">
                <h2>Vidrios de Alta Calidad</h2>
                <p>En Vidrios Y Aceros Sandra, ofrecemos una variedad de vidrios de alta calidad, incluyendo vidrios templados, flotantes, de seguridad y pintados. Nuestros productos destacan por su durabilidad, claridad y resistencia, proporcionando soluciones que superan las expectativas de nuestros clientes.</p>
                
                <div class="row">
                    <!-- Vidrios Templados -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/templado.jpeg') }}" class="card-img-top" alt="Vidrios Templados">
                            <div class="card-body">
                                <h5 class="card-title">Vidrios Templados</h5>
                                <p class="card-text">Los vidrios templados son conocidos por su resistencia y seguridad. Son ideales para aplicaciones que requieren durabilidad y protección.</p>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/flotante.jpeg') }}" class="card-img-top" alt="Vidrios Flotantes">
                            <div class="card-body">
                                <h5 class="card-title">Vidrios Flotantes</h5>
                                <p class="card-text">Los vidrios flotantes ofrecen una claridad excepcional y son perfectos para ventanas y puertas, proporcionando una vista nítida y sin distorsiones.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/seguridad.jpeg') }}" class="card-img-top" alt="Vidrios de Seguridad">
                            <div class="card-body">
                                <h5 class="card-title">Vidrios de Seguridad</h5>
                                <p class="card-text">Los vidrios de seguridad están diseñados para ofrecer una protección adicional, siendo ideales para áreas que requieren un nivel extra de seguridad.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
                    ...
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/pintado.jpeg') }}" class="card-img-top" alt="Vidrios Pintados">
                            <div class="card-body">
                                <h5 class="card-title">Vidrios Pintados</h5>
                                <p class="card-text">Los vidrios pintados añaden un toque de color y estilo a cualquier espacio, combinando estética y funcionalidad.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
            ...
            <div class="col-md-6">
                ...
                <form id="form-pedido" onsubmit="return validateForm()">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="color" name="color" placeholder="Ej. Transparente, Azul, Verde" required>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        function addToCart() {
            ...
            if (tipoVidrio && medidas && color && envio && correo) {
                const carrito = document.getElementById('carrito');
                const newItem = document.createElement('li');
                newItem.className = 'list-group-item';
                newItem.innerText = `${tipoVidrio} - ${medidas} - ${color} - ${envio} - ${correo}`;
