...
<head>
    ...
    <title>ProductAceros - Accesorios para Baños</title>
...
<body>
    <header class="header text-center py-3">
        <h1>ProductAceros - Accesorios para Baños</h1>
    ...
    <main class="container mt-5">
        <div class="row">
            <!-- Información de Accesorios para Baños -->
            <div class="col-md-6">
                <h2>Accesorios para Baños de Acero Inoxidable</h2>
                <p>En Vidrios Y Aceros Sandra, ofrecemos una variedad de accesorios para baños de acero inoxidable de alta calidad, incluyendo kits de 5 piezas, organizadores rectangulares de 2 estantes, colecciones completas y productos de la marca Mazinox. Nuestros productos destacan por su durabilidad, resistencia a la corrosión y estética moderna, proporcionando soluciones elegantes y funcionales para tu baño.</p>
                
                <div class="row">
                    <!-- Kit de 5 Piezas de Acero Inoxidable -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/kit_5_piezas.jpeg') }}" class="card-img-top" alt="Kit de 5 Piezas de Acero Inoxidable">
                            <div class="card-body">
                                <h5 class="card-title">Kit de 5 Piezas de Acero Inoxidable</h5>
                                <p class="card-text">Nuestro kit de 5 piezas de acero inoxidable incluye todo lo necesario para equipar tu baño con estilo y funcionalidad.</p>
                    ...
                    <!-- Organizador Rectangular 2 Estantes de Acero -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/organizador_2_estantes.jpeg') }}" class="card-img-top" alt="Organizador Rectangular 2 Estantes de Acero">
                            <div class="card-body">
                                <h5 class="card-title">Organizador Rectangular 2 Estantes de Acero</h5>
                                <p class="card-text">Nuestro organizador rectangular de 2 estantes en acero inoxidable es perfecto para mantener tu baño ordenado y elegante.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
                    ...
                    <!-- Colección de Accesorios de Baño de Acero Inoxidable -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/coleccion_accesorios_bano.jpeg') }}" class="card-img-top" alt="Colección de Accesorios de Baño de Acero Inoxidable">
                            <div class="card-body">
                                <h5 class="card-title">Colección de Accesorios de Baño de Acero Inoxidable</h5>
                                <p class="card-text">Nuestra colección de accesorios de baño de acero inoxidable incluye una variedad de productos diseñados para combinar funcionalidad y estilo.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
                    ...
                    <!-- Accesorios para Baños - Mazinox -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/accesorios_mazinox.jpeg') }}" class="card-img-top" alt="Accesorios para Baños - Mazinox">
                            <div class="card-body">
                                <h5 class="card-title">Accesorios para Baños - Mazinox</h5>
                                <p class="card-text">Los accesorios para baños Mazinox están hechos completamente de acero inoxidable, ofreciendo durabilidad y un diseño moderno para cualquier baño.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
            ...
            <div class="col-md-6">
                <h5>Solicita tus Accesorios para Baños</h5>
                <form id="form-pedido" onsubmit="return validateForm()">
                    <div class="form-group">
                        <label for="tipoAccesorio">Tipo de Accesorio</label>
                        <select class="form-control" id="tipoAccesorio" name="tipoAccesorio" required>
                            <option value="kit_5_piezas">Kit de 5 Piezas de Acero Inoxidable</option>
                            <option value="organizador_2_estantes">Organizador Rectangular 2 Estantes de Acero</option>
                            <option value="coleccion_accesorios">Colección de Accesorios de Baño de Acero Inoxidable</option>
                            <option value="accesorios_mazinox">Accesorios para Baños - Mazinox</option>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        function addToCart() {
            ...
            if (tipoAccesorio && medidas && color && envio && correo) {
                const carrito = document.getElementById('carrito');
                const newItem = document.createElement('li');
                newItem.className = 'list-group-item';
                newItem.innerText = `${tipoAccesorio} - ${medidas} - ${color} - ${envio} - ${correo}`;
