...
<head>
    ...
    <title>ProductVidrios - Repisas de Vidrio</title>
...
<body>
    <header class="header text-center py-3">
        <h1>ProductVidrios - Repisas de Vidrio</h1>
    ...
    <main class="container mt-5">
        <div class="row">
            <!-- Información de Repisas de Vidrio -->
            <div class="col-md-6">
                <h2>Repisas de Vidrio de Alta Calidad</h2>
                <p>En Vidrios Y Aceros Sandra, ofrecemos una variedad de repisas de vidrio de alta calidad, incluyendo repisas de vidrio con luces LED de 3 niveles, soportes de estantería con vidrio templado, estanterías repisa esquinera cristal 3 piezas negra o blanca, y repisas flotantes de vidrio templado. Nuestros productos destacan por su durabilidad, claridad y resistencia, proporcionando soluciones elegantes y funcionales para tu hogar.</p>
                
                <div class="row">
                    <!-- Repisa de Vidrio con Luces LED de 3 Niveles -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/repisa_led.jpeg') }}" class="card-img-top" alt="Repisa de Vidrio con Luces LED de 3 Niveles">
                            <div class="card-body">
                                <h5 class="card-title">Repisa de Vidrio con Luces LED de 3 Niveles</h5>
                                <p class="card-text">Nuestras repisas de vidrio con luces LED de 3 niveles ofrecen una solución moderna y elegante para exhibir tus objetos favoritos con una iluminación suave y atractiva.</p>
                    ...
                    <!-- Soporte de Estantería con Vidrio Templado -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/soporte_estanteria_vidrio_templado.jpeg') }}" class="card-img-top" alt="Soporte de Estantería con Vidrio Templado">
                            <div class="card-body">
                                <h5 class="card-title">Soporte de Estantería con Vidrio Templado</h5>
                                <p class="card-text">Nuestros soportes de estantería con vidrio templado combinan funcionalidad y estilo, proporcionando una solución resistente y estética para cualquier espacio.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
                    ...
                    <!-- Estantería Repisa Esquinera Cristal 3 Piezas Negra o Blanca -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/repisa_esquinera_cristal.jpeg') }}" class="card-img-top" alt="Estantería Repisa Esquinera Cristal 3 Piezas Negra o Blanca">
                            <div class="card-body">
                                <h5 class="card-title">Estantería Repisa Esquinera Cristal 3 Piezas Negra o Blanca</h5>
                                <p class="card-text">Nuestras estanterías repisa esquinera de cristal en 3 piezas están disponibles en negro o blanco, ofreciendo una solución elegante y funcional para aprovechar al máximo el espacio de las esquinas.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
                    ...
                    <!-- Repisa Flotante de Vidrio Templado -->
                    <div class="col-md-12 mb-4">
                        <div class="card">
                            <img src="{{ asset('images/repisa_flotante_vidrio_templado.jpeg') }}" class="card-img-top" alt="Repisa Flotante de Vidrio Templado">
                            <div class="card-body">
                                <h5 class="card-title">Repisa Flotante de Vidrio Templado</h5>
                                <p class="card-text">Nuestras repisas flotantes de vidrio templado ofrecen una solución moderna y minimalista para exhibir tus objetos, combinando durabilidad y estilo.</p>
                                <button class="btn btn-edit" onclick="editItem(this)">Editar</button>
                                <button class="btn btn-toggle" onclick="toggleItem(this)">Deshabilitar</button>
                                <button class="btn btn-save" onclick="saveItem(this)" style="display: none;">Guardar</button>
                                <button class="btn btn-delete" onclick="deleteItem(this)" style="display: none;">Eliminar</button>
            ...
            <div class="col-md-6">
                <h5>Solicita tu Repisa de Vidrio</h5>
                <form id="form-pedido" onsubmit="return validateForm()">
                    <div class="form-group">
                        <label for="tipoRepisa">Tipo de Repisa</label>
                        <select class="form-control" id="tipoRepisa" name="tipoRepisa" required>
                            <option value="">Selecciona un tipo de repisa</option>
                            <option value="led_3_niveles">Repisa de Vidrio con Luces LED de 3 Niveles</option>
                            <option value="soporte_vidrio_templado">Soporte de Estantería con Vidrio Templado</option>
                            <option value="esquinera_cristal">Estantería Repisa Esquinera Cristal 3 Piezas Negra o Blanca</option>
                            <option value="flotante_vidrio_templado">Repisa Flotante de Vidrio Templado</option>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        function addToCart() {
            const tipoRepisa = document.getElementById('tipoRepisa').value;
            const medidas = document.getElementById('medidas').value;
            const color = document.getElementById('color').value;
            const envio = document.getElementById('envio').value;
            const correo = document.getElementById('correo').value;

            if (tipoRepisa && medidas && color && envio && correo) {
                const carrito = document.getElementById('carrito');
                const newItem = document.createElement('li');
                newItem.className = 'list-group-item';
                newItem.innerText = `${tipoRepisa} - ${medidas} - ${color} - ${envio} - ${correo}`;
